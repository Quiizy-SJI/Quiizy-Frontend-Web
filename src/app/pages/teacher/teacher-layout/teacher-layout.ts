...
export class TeacherLayout implements OnInit {
  ...
  menuItems = [
    ...
    { id: 'materials', label: 'Course Materials', route: '/teacher/materials', icon: 'folder_open' },
  ...
  private syncTabFromUrl(url: string): void {
    ...
    else if (url.includes('/teacher/materials')) this.activeTab = 'materials';
  ...
  onTabChange(tabId: string | number): void {
    ...
    switch (nextTabId) {
      ...
      case 'question-bank':
        ...
        break;
      case 'materials':
        void this.router.navigateByUrl('/teacher/materials');
        break;
      case 'statistics':
