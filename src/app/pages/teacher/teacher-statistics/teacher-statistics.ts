    ...
    <div class="statistics">
      ...
      <div class="stats-overview">
        ...
        <div class="overview-card">
          ...
          <div class="card-content">
            <h3>Average Score</h3>
            <p class="main-stat">78.5%</p>
            <span class="trend positive">+2.3% improvement</span>
          </div>
        </div>
        ...
        <div class="overview-card">
          ...
          <div class="card-content">
            ...
            <p class="main-stat">42 min</p>
            <span class="trend negative">+3 min slower</span>
          </div>
        </div>
      </div>
